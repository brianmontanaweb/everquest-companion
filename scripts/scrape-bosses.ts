...
const TARGETS: Curated[] = [
  ...
  {
    name: 'Cazic Thule',
    category: 'Plane of Fear',
    p99: 'Cazic Thule (God)',
    match: ['Cazic Thule', 'Cazic-Thule'],
    zone: 'Plane of Fear',
  },
  ...
  { name: 'Fright', category: 'Plane of Fear', match: ['Fright'], zone: 'Plane of Fear' },
  {
    ...
    category: 'Plane of Fear',
    page: 'A dracoliche',
    match: ['a dracoliche', 'A dracoliche'],
    zone: 'Plane of Fear',
  },
  ...
  // Plane of Hate (Innoruuk + minis)
  {
    ...
    page: 'Innoruuk',
    match: ['Innoruuk, the Prince of Hate', 'Innoruuk'],
    zone: 'Plane of Hate',
  },
  {
  ...
  },
  {
    ...
    category: 'Plane of Hate',
    match: ['Mistress of Scorn'],
    zone: 'Plane of Hate',
  },
  {
    name: 'High Priest M`kari',
    category: 'Plane of Hate',
    match: ['High Priest M`kari'],
    zone: 'Plane of Hate',
  },
  { name: 'Magi P`tasa', category: 'Plane of Hate', match: ['Magi P`tasa'], zone: 'Plane of Hate' },
  {
    name: 'Coercer T`vala',
    category: 'Plane of Hate',
    match: ['Coercer T`vala'],
    zone: 'Plane of Hate',
  },
  {
    name: 'Grandmaster R`Tal',
    category: 'Plane of Hate',
    match: ['Grandmaster R`Tal'],
    zone: 'Plane of Hate',
  },
  {
    name: 'Ashenbone Broodmaster',
    category: 'Plane of Hate',
    match: ['Ashenbone Broodmaster'],
    zone: 'Plane of Hate',
  },
  {
    name: 'Avatar of Abhorrence',
    category: 'Plane of Hate',
    match: ['Avatar of Abhorrence'],
    zone: 'Plane of Hate',
  },
  ...
  // Plane of Sky (island bosses, in island order)
  {
    ...
    zone: 'Plane of Sky — Island 1',
  },
  {
    name: 'Noble Dojorn',
    category: 'Plane of Sky',
    match: ['Noble Dojorn'],
    zone: 'Plane of Sky — Island 1.5',
  },
  {
    name: 'Protector of Sky',
    category: 'Plane of Sky',
    match: ['Protector of Sky'],
    zone: 'Plane of Sky — Island 2',
  },
  {
    name: 'Gorgalosk',
    category: 'Plane of Sky',
    match: ['Gorgalosk'],
    zone: 'Plane of Sky — Island 3',
  },
  {
    name: 'Keeper of Souls',
    category: 'Plane of Sky',
    match: ['Keeper of Souls'],
    zone: 'Plane of Sky — Island 4',
  },
  {
    name: 'The Spiroc Lord',
    category: 'Plane of Sky',
    page: 'Spiroc Lord',
    match: ['The Spiroc Lord'],
    zone: 'Plane of Sky — Island 5',
  },
  {
    name: 'Bazzt Zzzt',
    category: 'Plane of Sky',
    match: ['Bazzt Zzzt'],
    zone: 'Plane of Sky — Island 6',
  },
  {
    name: 'Sister of the Spire',
    category: 'Plane of Sky',
    match: ['Sister of the Spire'],
    zone: 'Plane of Sky — Island 7',
  },
  {
    name: 'Eye of Veeshan',
    category: 'Plane of Sky',
    match: ['Eye of Veeshan'],
    zone: 'Plane of Sky — Island 8',
  },
  ...
  {
    name: 'Overseer of Air',
    category: 'Plane of Sky',
    match: ['Overseer of Air'],
    zone: 'Plane of Sky — Efreeti Cycle (Island 4)',
  },
  {
    name: 'The Hand of Veeshan',
    category: 'Plane of Sky',
    page: 'The Hand of Veeshan',
    match: ['The Hand of Veeshan', 'the Hand of Veeshan'],
    zone: 'Plane of Sky — Efreeti Cycle (Island 8)',
  },
]
...
async function p99Image(page: string): Promise<string | undefined> {
  ...
  const pick =
    srcs.find((s) => /Npc_/i.test(s)) ?? srcs.find((s) => !/Item_|WarningIcon|\.svg/i.test(s))
